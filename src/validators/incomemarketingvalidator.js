...
export const createIncomeMarketingValidator = [
  body("Date")
    .notEmpty()
  ...
  body("Income")
    ...
    .isString()
    .withMessage("Income must be a string"),
...
export const updateIncomeMarketingValidator = [
  body("Date")
    .notEmpty()
    .withMessage("Date is required")
    .isISO8601()
  ...
  body("Income").optional().isString().withMessage("Income must be a string"),
